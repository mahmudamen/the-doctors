...
class DocReg(models.Model):
    ...
    doc_name = fields.Many2one('doc.doc_doctors',domain=[('is_doctor','=',True)],string="doctor")
    doc_drugs = fields.Many2one('doc.doc_doctors', domain=[('is_doctor_drugs', '=', True)], string="doctor drugs")
    doc_assist = fields.Many2one('doc.doc_doctors', domain=[('is_doctor_assist', '=', True)], string="doctor assist")
